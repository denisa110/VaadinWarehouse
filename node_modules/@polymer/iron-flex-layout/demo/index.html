...
<script
	src="https://unpkg.com/@webcomponents/webcomponentsjs@^2.0.0/webcomponents-loader.js"></script>
<script type="module">
...
.flexchild { @apply --layout-flex;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-vertical { @apply --layout-vertical;
	height: 220px;
}

.flexchild-vertical { @apply --layout-flex;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-horizontal-with-ratios { @apply --layout-horizontal;
...
.flex2child { @apply --layout-flex-2;
	
}

.flex3child { @apply --layout-flex-3;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-stretch-align { @apply --layout-horizontal;
	height: 120px;
}
</style>
			</custom-style>
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-center-align { @apply --layout-horizontal; @apply --layout-center;
	height: 120px;
}
</style>
			</custom-style>
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-start-align { @apply --layout-horizontal; @apply --layout-start;
	height: 120px;
}
</style>
			</custom-style>
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-end-align { @apply --layout-horizontal; @apply --layout-end;
	height: 120px;
}
</style>
			</custom-style>
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-start-justified { @apply --layout-horizontal; @apply
	--layout-start-justified;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-center-justified { @apply --layout-horizontal; @apply
	--layout-center-justified;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-end-justified { @apply --layout-horizontal; @apply
	--layout-end-justified;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-equal-justified { @apply --layout-horizontal; @apply
	--layout-justified;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-equal-around-justified { @apply --layout-horizontal; @apply
	--layout-around-justified;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-self-align { @apply --layout-horizontal; @apply --layout-justified;
	height: 120px;
}

.flex-self-align div { @apply --layout-flex;
	
}

.child1 { @apply --layout-self-start;
	
}

.child2 { @apply --layout-self-center;
	
}

.child3 { @apply --layout-self-end;
	
}

.child4 { @apply --layout-self-stretch;
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-wrap { @apply --layout-horizontal; @apply --layout-wrap;
	width: 200px;
}
</style>
			</custom-style>
		...
		<template>
			<custom-style>
			<style is="custom-style">
.flex-reversed { @apply --layout-horizontal-reverse;
...
.block { @apply --layout-block;
	
}

.invisible { @apply --layout-invisible;
...
.fit { @apply --layout-fit;
			...
			<div class="general">
				<div>
					Before <span>[A Span]</span> After
				</div>
				<div>
					Before <span class="block">[A Block Span]</span> After
				</div>
				<div>
					Before invisible span <span class="invisible">Not displayed</span>
					After invisible span
				</div>
