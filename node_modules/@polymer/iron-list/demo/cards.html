...
app-header {
	...
	color: white; -
	-app-header-background-front-layer: { background-color : #4285f4;
}
...
.spacer { @apply --layout-flex;
		...
		<app-header condenses fixed
			effects="resize-title blend-background waterfall"> <app-toolbar>
		<paper-icon-button icon="menu" drawer-toggle></paper-icon-button>
		<h4 condensed-title>
			iron-list <i>&mdash; Demo</i>
		</h4>
		<paper-icon-button icon="search"></paper-icon-button> <paper-icon-button
			icon="more-vert"></paper-icon-button> </app-toolbar> <app-toolbar class="tall">
