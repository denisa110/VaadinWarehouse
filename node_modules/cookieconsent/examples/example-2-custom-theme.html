	...
	<div class="center-outer fit">
		<div class="center-inner">
			<div class="example-window" role="main">
				...
				<h1>
					<span>Demo 2</span> Custom CSS
				</h1>

				<p>
					See every part of <a href="http://cookieconsent.insites.com/">Cookie
						Consent</a> overridden with slightly crazy custom CSS.
				</p>

				<ul class="example-selector"></ul>

				<a href="examples/example-1-themes.html"
