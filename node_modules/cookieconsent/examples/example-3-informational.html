	...
	<div class="center-outer fit">
		<div class="center-inner">
			<div class="example-window" role="main">
				...
				<h1>
					<span>Demo 3</span> Informational
				</h1>

				<p>
					An <a
						href="http://cookieconsent.insites.com/documentation/compliance/#informational">informational</a>
					notice simply tells users that we use cookies, and lets the user
					dismiss the message. This is the simplest solution, and recommended
					for most websites.
				</p>

				<ul class="example-selector"></ul>

				<a href="examples/example-2-custom-theme.html"
					class="page-switcher page-switcher-prev" title="Previous demo">&#9664;</a>
				<a href="examples/example-4-opt-out.html"
