	...
	<div class="center-outer fit">
		<div class="center-inner">
			<div class="example-window" role="main">
				<h1>
					<span>Demo 5</span> Opt-in
				</h1>

				<p>
					An <a
						href="http://cookieconsent.insites.com/documentation/compliance/#opt-in">opt-in</a>
					notice ask users for permission to use cookies. Unless they say so,
					no cookies will be used. A small tab allows them to change their
					mind later.
				</p>
				...
				<a href="examples/example-6-location.html"
