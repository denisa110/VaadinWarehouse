	...
	<div class="center-outer fit">
		<div class="center-inner">
			<div class="example-window" role="main">
				<h1>
					<span>Demo 6</span> Location
				</h1>
				<p>
					If you want, <a href="http://cookieconsent.insites.com/">Cookie
						Consent</a> can automatically adapt to the user's location. Choose a
					country and see how the law and banner changes:
				</p>

				<div class="form-controls">
					<label>Country</label> <select id="location" class="selectbox"></select>
				</div>
				...
				<a href="examples/example-7-javascript-api.html"
