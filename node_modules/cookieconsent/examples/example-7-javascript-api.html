	...
	<div class="center-outer fit">
		<div class="center-inner">
			<div class="example-window" role="main">
				...
				<h1>
					<span>Demo 7</span> JavaScript API
				</h1>

				<p>
					Programmers can hook into our <a
						href="http://cookieconsent.insites.com/documentation/javascript-api/">JavaScript
						API</a>. Fire events to see what happens:
				</p>
				...
				<div class="btn-group">
					...
					<button type="button" class="btn" id="btn-revokeChoice">Revoke
						choice</button>
				</div>
