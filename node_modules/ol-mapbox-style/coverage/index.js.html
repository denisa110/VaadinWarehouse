		...
		<div class='pad1'>
			...
			<div class='clearfix'>
				...
				<div class='fl pad1y space-right2'>
					<span class="strong">91.95% </span> <span class="quiet">Statements</span>
					<span class='fraction'>320/348</span>
				</div>


				<div class='fl pad1y space-right2'>
					<span class="strong">86.36% </span> <span class="quiet">Branches</span>
					<span class='fraction'>209/242</span>
				</div>


				<div class='fl pad1y space-right2'>
					<span class="strong">96% </span> <span class="quiet">Functions</span>
					<span class='fraction'>48/50</span>
				</div>


				<div class='fl pad1y space-right2'>
					<span class="strong">92.09% </span> <span class="quiet">Lines</span>
...
<a name='L912'></a><a href='#L912'>912</a></td>
...
function hasFontFamily(family) {
  if (!loadedFontFamilies) {
    ...
    for (let i = 0, ii = styleSheets.length; i &lt; ii; ++i) {
      const styleSheet = /** @type {CSSStyleSheet} */ (<span
								class="cstat-no" title="statement not covered">styleSheets[i])</span>;
<span class="cstat-no" title="statement not covered">      try {</span>
        const cssRules = <span class="cstat-no"
								title="statement not covered">styleSheet.rules || styleSheet.cssRules;</span>
<span class="cstat-no" title="statement not covered">        if (cssRules) {</span>
<span class="cstat-no" title="statement not covered">          for (let j = <span
								class="cstat-no" title="statement not covered">0,</span> jj = <span
								class="cstat-no" title="statement not covered">cssRules.length;</span> j &lt; jj; ++j) {</span>
            const cssRule = <span class="cstat-no"
								title="statement not covered">cssRules[j];</span>
<span class="cstat-no" title="statement not covered">            if (cssRule.type == 5) {</span>
              const match = <span class="cstat-no"
								title="statement not covered">cssRule.cssText.match(fontFamilyRegEx);</span>
...
function setBackground(mapOrLayer, layer) {
  ...
  function updateStyle(resolution) {
    ...
    const paint = layer.paint || <span class="branch-1 cbranch-no"
...
<span class="cstat-no" title="statement not covered">      layer.setSource(undefined);</span>
  ...
  source.setTileLoadFunction(<span class="fstat-no"
								title="function not covered">fu</span>nction (tile, src) {
...
<span class="cstat-no" title="statement not covered">      src = src.replace('{bbox-epsg-3857}', bbox.toString());</span>
    ...
    const img = /** @type {import("ol/ImageTile").default} */ <span
								class="cstat-no" title="statement not covered">(tile).getImage();</span>
    /** @type {HTMLImageElement} */ <span class="cstat-no"
								title="statement not covered">(img).src = src;</span>
  });
  return layer;
}
&nbsp;
          ...
          if (url.indexOf('mapbox://') == 0) {
            ...
            glSource.tiles = ['a', 'b', 'c', 'd'].map(function (host) {
              return (
                ...
                mapid +
                '/{z}/{x}/{y}.' +
                (glSource.type == 'vector' ? 'vector.pbf' : <span
								class="branch-1 cbranch-no" title="branch not covered">'png')</span> +
                accessToken
              );
            });
...
&nbsp;
        if (glSource.type == 'vector') {
          ...
          updateRasterLayerProperties(glLayer, layer, view, functionCache);
								...
								title="else path not taken">E</span>if (glSource.type == 'geojson') {
