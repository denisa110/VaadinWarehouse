...
<body>
	<div class='wrapper'>
		<div class='pad1'>
			<h1>
				<a href="index.html">All files</a> stylefunction.js
			</h1>
			<div class='clearfix'>

				<div class='fl pad1y space-right2'>
					<span class="strong">62.59% </span> <span class="quiet">Statements</span>
					<span class='fraction'>256/409</span>
				</div>


				<div class='fl pad1y space-right2'>
					<span class="strong">56% </span> <span class="quiet">Branches</span>
					<span class='fraction'>182/325</span>
				</div>


				<div class='fl pad1y space-right2'>
					<span class="strong">61.11% </span> <span class="quiet">Functions</span>
					<span class='fraction'>11/18</span>
				</div>


				<div class='fl pad1y space-right2'>
					<span class="strong">62.68% </span> <span class="quiet">Lines</span>
					<span class='fraction'>252/402</span>
				</div>
...
<tr>
					<td class="line-count quiet"><a name='L1'></a><a href='#L1'>1</a>
...
<a name='L1272'></a><a href='#L1272'>1272</a></td>
...
<span class="cstat-no" title="statement not covered">    throw new Error(</span>
      compiledExpression.value
        .map(<span class="fstat-no" title="function not covered">(e</span>rr) =&gt; <span
								class="cstat-no" title="statement not covered">`${err.key}: ${err.message}`)</span>
        .join(', ')
    );
  }
...
&nbsp;
  ...
  if (spriteImageUrl) {
    <span class="missing-if-branch" title="else path not taken">E</span>if (typeof Image !== 'undefined') {
      ...
      const worker = /** @type {*} */ (<span class="cstat-no"
								title="statement not covered">self)</span>;
      // Main thread needs to handle 'loadImage' and dispatch 'imageLoaded'
<span class="cstat-no" title="statement not covered">      worker.postMessage({</span>
        action: 'loadImage',
        src: spriteImageUrl,
      });
<span class="cstat-no" title="statement not covered">      worker.addEventListener('message', function <span
								class="fstat-no" title="function not covered">handler(</span>event) {</span>
      ...
      if (!filter || evaluateFilter(layerId, filter, f, zoom, filterCache)) {
        ...
        if (
          ...
          <span class="missing-if-branch" title="if path not taken">I</span>if (layer.type + '-pattern' in paint) {
            const fillIcon = <span class="cstat-no"
								title="statement not covered">getValue(</span>
              layer,
              'paint',
              layer.type + '-pattern',
              zoom,
...
<span class="cstat-no" title="statement not covered">                style.setZIndex(index);</span>
                const icon_cache_key = <span class="cstat-no"
								title="statement not covered">icon + '.' + opacity;</span>
                let pattern = <span class="cstat-no"
								title="statement not covered">patternCache[icon_cache_key];</span>
<span class="cstat-no" title="statement not covered">                if (!pattern) {</span>
                  const spriteImageData = <span class="cstat-no"
								title="statement not covered">spriteData[icon];</span>
                  const canvas = <span class="cstat-no"
								title="statement not covered">createCanvas(</span>
...
<span class="cstat-no" title="statement not covered">                fill.setColor(pattern);</span>
            ...
            if (color || strokeColor) {
              ...
              if (
                !style ||
                (color &amp;&amp; !style.getFill()) ||
                (!color &amp;&amp; <span class="branch-4 cbranch-no"
								title="branch not covered">style.getFill())</span> ||
                (strokeColor &amp;&amp; !style.getStroke()) ||
                (!strokeColor &amp;&amp; <span
								class="branch-8 cbranch-no" title="branch not covered">style.getStroke())</span> ||
                style.getText()
              ) {
                style = new Style({
                  fill: color ? new Fill() : undefined,
                  stroke: strokeColor ? new Stroke() : <span
								class="branch-1 cbranch-no" title="branch not covered">undefined,</span>
                });
              ...
              <span class="missing-if-branch"
								title="else path not taken">E</span>if (strokeColor) {
        ...
        if (type != 1 &amp;&amp; layer.type == 'line') {
          color =
            !('line-pattern' in paint) &amp;&amp; 'line-color' in paint
              ...
              : <span class="branch-1 cbranch-no"
								title="branch not covered">undefined;</span>
          ...
          <span class="missing-if-branch" title="else path not taken">E</span>if (color &amp;&amp; width &gt; 0) {
            ...
            stroke.setLineDash(
              paint['line-dasharray']
                ? <span class="branch-0 cbranch-no"
								title="branch not covered">getValue(</span>
                    layer,
                    'paint',
                    'line-dasharray',
                    zoom,
                    f,
                    functionCache
                  ).map(<span class="fstat-no"
								title="function not covered">fu</span>nction (x) {
          ...
          <span class="missing-if-branch" title="else path not taken">E</span>if (iconImage) {
            icon =
              typeof iconImage === 'string'
                ...
                : <span class="branch-1 cbranch-no"
								title="branch not covered">iconImage.toString();</span>
            ...
            if (spriteImage &amp;&amp; spriteData &amp;&amp; spriteData[icon]) {
              ...
              <span class="missing-if-branch" title="if path not taken">I</span>if (type == 2) {
                const geom = <span class="cstat-no"
								title="statement not covered">feature.getGeometry();</span>
                // ol package and ol-debug.js only
<span class="cstat-no" title="statement not covered">                if (geom.getFlatMidpoint || geom.getFlatMidpoints) {</span>
                  const extent = <span class="cstat-no"
								title="statement not covered">geom.getExtent();</span>
                  const size = <span class="cstat-no"
								title="statement not covered">Math.sqrt(</span>
                    Math.max(
...
<span class="cstat-no" title="statement not covered">                    renderFeatureCoordinates[1] = midpoint[1];</span>
                    const placement = <span class="cstat-no"
								title="statement not covered">getValue(</span>
                      layer,
                      'layout',
                      'symbol-placement',
...
<span class="cstat-no" title="statement not covered">                    if (</span>
                      ...
                      const stride = <span class="cstat-no"
								title="statement not covered">geom.getStride();</span>
                      const coordinates = <span class="cstat-no"
								title="statement not covered">geom.getFlatCoordinates();</span>
<span class="cstat-no" title="statement not covered">                      for (</span>
                        let i = <span class="cstat-no"
								title="statement not covered">0,</span> ii = <span
								class="cstat-no" title="statement not covered">coordinates.length - stride;</span>
                        i &lt; ii;
                        i += stride
                      ) {
                        const x1 = <span class="cstat-no"
								title="statement not covered">coordinates[i];</span>
                        const y1 = <span class="cstat-no"
								title="statement not covered">coordinates[i + 1];</span>
                        const x2 = <span class="cstat-no"
								title="statement not covered">coordinates[i + stride];</span>
                        const y2 = <span class="cstat-no"
								title="statement not covered">coordinates[i + stride + 1];</span>
                        const minX = <span class="cstat-no"
								title="statement not covered">Math.min(x1, x2);</span>
                        const minY = <span class="cstat-no"
								title="statement not covered">Math.min(y1, y2);</span>
                        const maxX = <span class="cstat-no"
								title="statement not covered">Math.max(x1, x2);</span>
                        const maxY = <span class="cstat-no"
								title="statement not covered">Math.max(y1, y2);</span>
<span class="cstat-no" title="statement not covered">                        if (</span>
                          midpoint[0] &gt;= minX &amp;&amp;
                          midpoint[0] &lt;= maxX &amp;&amp;
                          midpoint[1] &gt;= minY &amp;&amp;
...
<span class="cstat-no" title="statement not covered">                          break;</span>
              ...
              <span class="missing-if-branch"
								title="else path not taken">E</span>if (type !== 2 || <span
								class="branch-1 cbranch-no" title="branch not covered">styleGeom)</span> {
                ...
                <span class="missing-if-branch"
								title="if path not taken">I</span>if (!iconColor || iconColor.a !== 0) {
                  let icon_cache_key = <span class="cstat-no"
								title="statement not covered">icon + '.' + iconSize;</span>
                        ...
                        'icon-offset' in layout
                          ? getValue(
                              ...
                              functionCache
								...
								title="function not covered">(v</span>) =&gt; <span
								class="cstat-no" title="statement not covered">-v * spriteImageData.pixelRatio)</span>
                          : undefined,
                    });
<span class="cstat-no" title="statement not covered">                    iconImageCache[icon_cache_key] = iconImg;</span>
                ...
                <span class="missing-if-branch"
								title="if path not taken">I</span>if (iconImg) {
<span class="cstat-no" title="statement not covered">                  ++stylesLength;</span>
<span class="cstat-no" title="statement not covered">                  style = styles[stylesLength];</span>
<span class="cstat-no" title="statement not covered">                  if (</span>
                    !style ||
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken">I</span>if (type == 1 &amp;&amp; layer.type === 'circle') {
<span class="cstat-no" title="statement not covered">          ++stylesLength;</span>
<span class="cstat-no" title="statement not covered">          style = styles[stylesLength];</span>
<span class="cstat-no" title="statement not covered">          if (</span>
            !style ||
...
<span class="cstat-no" title="statement not covered">            styles[stylesLength] = style;</span>
          ...
          const circleRadius =
<span class="cstat-no" title="statement not covered">            'circle-radius' in paint</span>
              ? getValue(
                  layer,
                  'paint',
                  'circle-radius',
              ...
              : 5;
          const circleStrokeColor = <span class="cstat-no"
								title="statement not covered">colorWithOpacity(</span>
            getValue(
              layer,
              'paint',
              'circle-stroke-color',
...
&nbsp;
        ...
        if ('text-field' in layout) {
          ...
          font = mb2css(
            getFonts ? getFonts(fontArray) : <span
								class="branch-1 cbranch-no" title="branch not covered">fontArray,</span>
            textSize,
            textLineHeight
          );
          ...
          <span class="missing-if-branch" title="if path not taken">I</span>if (typeof textField === 'object' &amp;&amp; <span
								class="branch-1 cbranch-no" title="branch not covered">textField.sections)</span> {
<span class="cstat-no" title="statement not covered">            if (textField.sections.length === 1) {</span>
<span class="cstat-no" title="statement not covered">              label = textField.toString();</span>
            } else {
<span class="cstat-no" title="statement not covered">              label = textField.sections.reduce(<span
								class="fstat-no" title="function not covered">(a</span>cc, chunk, i) =&gt; {</span>
                const fonts = <span class="cstat-no"
								title="statement not covered">chunk.fontStack</span>
                  ? chunk.fontStack.split(',')
                  : fontArray;
                const chunkFont = <span class="cstat-no"
								title="statement not covered">mb2css(</span>
                  getFonts ? getFonts(fonts) : fonts,
                  textSize * (chunk.scale || 1),
                  textLineHeight
                );
                let text = <span class="cstat-no"
								title="statement not covered">chunk.text;</span>
<span class="cstat-no" title="statement not covered">                if (text === '\n') {</span>
<span class="cstat-no" title="statement not covered">                  acc.push('\n', '');</span>
<span class="cstat-no" title="statement not covered">                  return acc;</span>
                }
<span class="cstat-no" title="statement not covered">                if (type == 2) {</span>
<span class="cstat-no" title="statement not covered">                  acc.push(applyLetterSpacing(text, letterSpacing), chunkFont);</span>
<span class="cstat-no" title="statement not covered">                  return;</span>
                }
<span class="cstat-no" title="statement not covered">                text = wrapText(</span>
                  text,
                  chunkFont,
                  maxTextWidth,
                  letterSpacing
                ).split('\n');
<span class="cstat-no" title="statement not covered">                for (let i = <span
								class="cstat-no" title="statement not covered">0,</span> ii = <span
								class="cstat-no" title="statement not covered">text.length;</span> i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered">                  if (i &gt; 0) {</span>
<span class="cstat-no" title="statement not covered">                    acc.push('\n', '');</span>
                  }
<span class="cstat-no" title="statement not covered">                  acc.push(text[i], chunkFont);</span>
                }
<span class="cstat-no" title="statement not covered">                return acc;</span>
              }, []);
            }
...
<span class="cstat-no" title="statement not covered">            label = Array.isArray(label)</span>
              ? label.map(<span class="fstat-no"
								title="function not covered">(t</span>, i) =&gt; (<span
								class="cstat-no" title="statement not covered">i % 2 ? t : t.toUpperCase())</span>)
              : label.toUpperCase();
          } else <span class="missing-if-branch"
								title="if path not taken">I</span>if (textTransform == 'lowercase') {
<span class="cstat-no" title="statement not covered">            label = Array.isArray(label)</span>
              ? label.map(<span class="fstat-no"
								title="function not covered">(t</span>, i) =&gt; (<span
								class="cstat-no" title="statement not covered">i % 2 ? t : t.toLowerCase())</span>)
              : label.toLowerCase();
          }
          const wrappedLabel = Array.isArray(label)
            ? <span class="branch-0 cbranch-no"
								title="branch not covered">label</span>
            : type == 2
...
<span class="cstat-no" title="statement not covered">              hOffset = textHaloWidth;</span>
								...
								title="if path not taken">I</span>if (textAnchor.indexOf('right') !== -1) {
...
<span class="cstat-no" title="statement not covered">              hOffset = -textHaloWidth;</span>
          ...
          if (textAnchor.indexOf('bottom') == 0) {
            ...
            vOffset = -textHaloWidth - 0.5 * (textLineHeight - 1) * textSize;
								...
								title="if path not taken">I</span>if (textAnchor.indexOf('top') == 0) {
...
<span class="cstat-no" title="statement not covered">            textHaloWidth *= 2;</span>
            ...
            const halfTextSize = <span class="cstat-no"
								title="statement not covered">0.5 * textSize;</span>
...
&nbsp;</pre></td>
	...
	<div class='footer quiet pad2 space-top1 center small'>
		Code coverage generated by <a href="https://istanbul.js.org/"
			target="_blank">istanbul</a> at Thu Feb 24 2022 12:53:02 GMT+0100
